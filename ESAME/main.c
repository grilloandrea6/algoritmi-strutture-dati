// formato del file
// prima riga: nRegioni
// nRiquadri righe: i j dim1 dim2
// i e j coordinate inizio del riquadro, dim1 e dim2 dimensioni delle sottoregioni
// si ritiene necessario creare un'altra matrice in cui
// copiare i dati di quella originale
// in quanto la matrice viene "sporcata" dall'algoritmo,
// e si ritiene utile mantenere quella originale per utilizzi successivi
// ret = 1 -> proposta valida
// ret = 0 -> proposta non valida
// n_regioni contiene il numero di sottoregioni utilizzate
